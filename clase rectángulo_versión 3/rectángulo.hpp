...
private:
    ...
    static char caracter_relleno;
    static char caracter_contorno;
...
public:
    ...
    void set_caracter_relleno(char caracter_relleno);
    void set_caracter_contorno(char caracter_contorno);
