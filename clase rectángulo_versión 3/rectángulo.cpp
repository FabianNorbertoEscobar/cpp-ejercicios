...
char Rectangulo::caracter_relleno='X';
char Rectangulo::caracter_contorno='O';
...
void Rectangulo::set_caracter_relleno(char caracter_relleno)
{
    this->caracter_relleno=caracter_relleno;
}

void Rectangulo::set_caracter_contorno(char caracter_contorno)
{
    this->caracter_contorno=caracter_contorno;
}
...
void Rectangulo::dibujar()const
{
    ...
    for(double i=0.0;i<x_esq2;i+=0.1)
    {
        cout << endl;
        for(double j=0.0;j<y_esq4;j+=0.1)
        {
            if(i==x_esq1||i==x_esq3||j==y_esq1||j==y_esq2)
                cout << " " << caracter_contorno;
            else
                cout << " " << caracter_relleno;
        }
